...
import com.overtake.objectlist.stickylistview.WrapperViewLis.LifeCycleListener;
...
public class StickyListHeadersListView extends FrameLayout {
    ...
    public StickyListHeadersListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mList.getRefreshableView().setCacheColorHint(attrsList.getCacheColorHint());
        mList.getRefreshableView().setFastScrollEnabled(attrsList.isFastScrollEnabled());
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            mList.getRefreshableView().setChoiceMode(attrsList.getChoiceMode());
            mList.getRefreshableView().setFastScrollAlwaysVisible(attrsList.isFastScrollAlwaysVisible());
        }
        ...
        mList.getRefreshableView().setSelector(attrsList.getSelector());
        mList.getRefreshableView().setScrollingCacheEnabled(attrsList.isScrollingCacheEnabled());
        ...
        WrapperViewLis list = (WrapperViewLis)mList.getRefreshableView();
        list.setLifeCycleListener(new WrapperViewListLifeCycleListener());
    ...
    private void clearHeader() {
        if (mHeader != null) {
            ...
            mList.getList().setTopClippingLength(0);
    ...
    private void updateOrClearHeader(int firstVisiblePosition) {
        ...
        final boolean isFirstViewBelowTop = doesListHaveChildren && mList.getRefreshableView()
    ...
    private void updateHeader(int firstVisiblePosition) {
        ...
        for (int i = 0; i < mList.getChildCount(); i++) {
            ...
            final boolean isChildFooter = mList.getList().containsFooterView(child);
        ...
        if (!mIsDrawingListUnderStickyHeader) {
            mList.getList().setTopClippingLength(mHeader.getMeasuredHeight()
                    + mHeaderOffset);
        }
    ...
    private class WrapperListScrollListener implements OnScrollListener {
        ...
        public void onScroll(AbsListView view, int firstVisibleItem,
            ...
            updateOrClearHeader(mList.getList().getFixedFirstVisibleItem());
        }
    ...
    public void addFooterView(View v) {
        mList.getList().addFooterView(v);
    }

    public void removeFooterView(View v) {
        mList.getList().removeFooterView(v);
    }
    ...
    public void setFooterDividersEnabled(boolean footerDividersEnabled){
    	mList.getRefreshableView().setFooterDividersEnabled(footerDividersEnabled);
    }
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    ...
    public void setCacheColorHint(int color){
    	mList.getRefreshableView().setCacheColorHint(color);
    }
    /**
