...
public class AsyncHttpClient {
	...
	public final ArrayList<AsyncHttpRequest> httpRequests;
	...
	public AsyncHttpClient() {
		...
		httpRequests = new ArrayList<AsyncHttpRequest>();
	}
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public AsyncHttpRequest post(Context context, String url, Header[] headers, RequestParams params, String contentType, AsyncHttpResponseHandler responseHandler) {
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public AsyncHttpRequest post(Context context, String url, Header[] headers, HttpEntity entity, String contentType, AsyncHttpResponseHandler responseHandler) {
	...
	protected AsyncHttpRequest sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, AsyncHttpResponseHandler responseHandler, Context context) {
		...
		AsyncHttpRequest httpRequest = new AsyncHttpRequest(client, httpContext, uriRequest, responseHandler);
		Future<?> request = threadPool.submit(httpRequest);
		httpRequest.futureRef = new WeakReference<Future<?>>(request);
	...
	private HttpEntity paramsToEntity(RequestParams params, AsyncHttpResponseHandler progressHandler) {
